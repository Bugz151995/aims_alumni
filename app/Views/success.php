...
<head>
    ...
    <title>Lagonoy High School Alumni</title>
    <style>
        ...
        * {
        ...
        html {
            background-image: url('http://lhs-alumni.edu.ph/bg.jpg');
        ...
        .topHalf {
            ...
            background: -webkit-linear-gradient(45deg, #00cdd4, #0144ff);
        }
    ...
    <div class="wrapperAlert">
        ...
        <div class="contentAlert">
            ...
            <div class="bottomHalf">
                ...
                <p>Well Done!, You have successfully created your alumni account!</p>

                <a href="<?= base_url() ?>" id="alertMO">Login Now</a>
